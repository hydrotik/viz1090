...
- Off-screen aircraft: active tracked aircraft outside the current viewport draw a semi-transparent bearing line from near screen center toward the edge chevrons. This makes off-screen radio-captured traffic visible at the current pan/zoom without drawing aircraft icons in the wrong location.
